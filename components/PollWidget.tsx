...
const optionNodes = poll.options.map(function (opt, idx) {
  ...
  const isSelected = selected === opt._id
                                     ...
                                     if (showResults) {
                                       return e('div', { key: opt._id, className: 'relative' },
                                                e('div', { className: 'flex items-center justify-between text-sm mb-1' },
                                                  e('span', { className: 'font-medium ' + (isSelected ? 'text-rose-600 dark:text-rose-400' : 'text-gray-700 dark:text-gray-200') },
                                                    opt.text + ' ',
                                     ...
                                     return e('button', {
                                       ...
                                       className: 'w-full text-left px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-800 dark:text-gray-100 hover:border-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
                                     }, opt.text)
})
