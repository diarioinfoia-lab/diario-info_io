...
const COL_TYPES = ['Noticia', 'Multimedia', 'Publicidad', 'Playlist de Videos'];
...
function getLayoutIcon(layout: string, columns?: {type: string}[]) {
...
function TemplateModal({ template, onClose, onSave }: TemplateModalProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError('Error de conexiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n');
    }
    setSaving(false);
  };
...
export default function BlocksPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¿Eliminar esta plantilla?')) return;
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">GestiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de plantillas de bloques</p>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">CÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³digo</th>
